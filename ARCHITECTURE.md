...
Configured addresses exist for all 8 chains, but the testnet path is not equally production-ready. OP Sepolia still
contains an inline PoolManager TODO and should be treated as a validation target, not as proof that the full testnet
matrix is release-ready.

...
contract VerifyHelperHarness is Verify {
    ...
    function expectedRoundDuration() external pure returns (uint256) {
        return _expectedRoundDuration();
    }
}
...
contract VerifyHelperProperties is Test {
    ...
    // =========================================================================
    // Property: _expectedRoundDuration is the documented 7 days
    // =========================================================================
    function test_roundDuration_isSevenDays() public view {
        assertEq(vh.expectedRoundDuration(), 7 days, "round duration must be 7 days");
        assertEq(vh.expectedRoundDuration(), 604_800, "round duration must be 604800 seconds");
    }
}
